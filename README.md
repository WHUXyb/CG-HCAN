# CG-HCAN: Category-Guided Hierarchical Cross-Attention Network for Remote Sensing Segmentation
...
- **🏗️ Novel Architecture**: CG-HCAN with dual-encoder UNet++ and BiCAF fusion
...
CG-HCAN Framework:
├── Dual-Branch Encoder
│   ├── RGB Image Branch (EfficientNet-B0)
...
### GID Dataset (Land Use Classification)

| Method              | Level-2 mIoU | Level-3 mIoU | Overall mIoU | Parameters |
| ------------------- | ------------ | ------------ | ------------ | ---------- |
...
| Component           | Level-2 mIoU | Level-3 mIoU | Improvement |
| ------------------- | ------------ | ------------ | ----------- |
| Baseline (UNet++)   | 74.8%        | 67.9%        | -           |
| + BiCAF Fusion      | 76.2%        | 69.3%        | +1.8%       |
| + CLIP-GNN          | 77.1%        | 70.4%        | +2.0%       |
| + Hierarchy Consistency | 78.5%    | 71.2%        | +2.5%       |
